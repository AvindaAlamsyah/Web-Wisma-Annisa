            ...
            <div class="navbar-header" style="width:100%;">
              <div class="opener-left-menu is-open">
                ...
                <a href="index.html" class="navbar-brand"> 
                 <b>KOS WISMA ANNISA</b>
                </a>

              

              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>M.Wahyu</span></li>
              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                      <a class="tree-toggle nav-header"><span class="fa fa-user"></span> Data Penghuni 
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="<?php echo base_url('datapenghuni');?>">Penghuni</a></li>
                        <li><a href="<?php echo base_url('home');?>">Pendaftar</a></li>
                      </ul>
                    </li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa fa-usd"></span> Info Pembayaran
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="<?php echo base_url('home');?>">Tanggungan</a></li>
                        <li><a href="<?php echo base_url('home');?>">Pembayaran</a></li>
                      </ul>
                    </li>
                    <li class="ripple">
                      <a href="<?php echo base_url('home');?>">
                        <span class="fa fa-commenting"></span>Keluhan
                      </a>
                    </li>
                    <li class="ripple"><a href="<?php echo base_url('home');?>"><span class="fa fa-money"></span> Operasional</a>
                    </li>
                    <li class="ripple"><a href="<?php echo base_url('home');?>"><span class="fa fa-line-chart"></span> Laporan Keuangan</a>
                    </li>
